...
| DA7 | Insecure Communication | [Network surface and plaintext protocol discovery](network-surface-and-plaintext-protocols.md); TLS and certificate validation; downgrade, proxy, and replay testing | In progress |
