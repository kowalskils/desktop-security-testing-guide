...
| DA3 | Sensitive Data Exposure | [Sensitive data exposure in process memory](mem-analysis.md); [sensitive data in binaries and application resources](binary-and-resource-inspection.md); [sensitive data in local storage and the Windows Registry](local-storage-and-registry-security.md); logs; and temporary artifacts | In progress |
