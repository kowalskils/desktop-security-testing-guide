...
| DA5 | Improper Authorization | [Filesystem and Registry authorization boundaries](filesystem-and-registry-authorization.md); process and service privileges; role enforcement; privileged operations; and local IPC authorization | In progress |
