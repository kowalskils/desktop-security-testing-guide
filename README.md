...
| --- | --- | --- | --- |
| DA1 | Injections | [OS command and argument injection](docs/da1-injections/da1-t01-os-command-argument-injection.md); [SQL query injection](docs/da1-injections/da1-t02-sql-query-injection.md); planned: LDAP, XML, XPath, and rendered-content injection | In progress |
