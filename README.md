...
| DA7 | Insecure Communication | [Network surface and plaintext protocol discovery](network-surface-and-plaintext-protocols.md); [TLS, certificate, proxy, and downgrade validation](tls-certificate-proxy-and-downgrade-validation.md); message integrity and replay testing | In progress |
