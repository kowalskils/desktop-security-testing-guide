...
| DA8 | Poor Code Quality | [DLL hijacking](docs/da8-poor-code-quality/da8-t01-dll-hijacking.md); [binary hardening, code signing, and release integrity](docs/da8-poor-code-quality/da8-t02-binary-hardening-code-signing.md); unsafe memory behavior and crash triage | In progress |
