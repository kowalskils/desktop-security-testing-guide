...
| DA6 | Security Misconfiguration | [Installer, updater, and service security configuration](installer-updater-and-service-configuration.md); file handlers; parsers; firewall rules; Registry settings; and supporting services | In progress |
