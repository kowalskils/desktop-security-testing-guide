...
| --- | --- | --- | --- |
| DA1 | Injections | [OS command and argument injection](docs/da1-injections/da1-t01-os-command-argument-injection.md); [SQL query injection](docs/da1-injections/da1-t02-sql-query-injection.md); [LDAP, XML, and XPath injection](docs/da1-injections/da1-t03-ldap-xml-xpath-injection.md); planned: rendered-content injection | In progress |
