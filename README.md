...
| DA4 | Improper Cryptography Usage | [Cryptographic algorithms, modes, parameters, and randomness](cryptographic-algorithms-modes-and-randomness.md); [cryptographic key lifecycle and protection](cryptographic-key-lifecycle.md); password-based protection; hashing; and integrity controls | In progress |
