...
| DA5 | Improper Authorization | [Filesystem and Registry authorization boundaries](filesystem-and-registry-authorization.md); [process, service, UAC, and privileged operation boundaries](process-service-and-privileged-operations.md); role enforcement; and local IPC authorization | In progress |
