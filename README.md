...
| DA10 | Insufficient Logging and Monitoring | [Security event coverage and correlation](docs/da10-insufficient-logging-monitoring/da10-t01-security-event-coverage-correlation.md); [log integrity and failure resilience](docs/da10-insufficient-logging-monitoring/da10-t02-log-integrity-failure-resilience.md); planned: forwarding and alerts | In progress |
