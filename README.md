...
| DA10 | Insufficient Logging and Monitoring | [Security event coverage and correlation](docs/da10-insufficient-logging-monitoring/da10-t01-security-event-coverage-correlation.md); planned: log integrity, failure resilience, forwarding, and alerts | In progress |
